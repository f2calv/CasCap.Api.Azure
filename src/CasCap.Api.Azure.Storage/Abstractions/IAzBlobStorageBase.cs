...
/// <summary>Defines the contract for interacting with an Azure Blob Storage container.</summary>
public interface IAzBlobStorageBase
{
    /// <summary>Gets the name of the blob container this instance targets.</summary>
    string ContainerName { get; }

    /// <summary>Creates the blob container if it does not already exist.</summary>
    ...
    /// <summary>Deletes the blob with the specified name from the container, if it exists.</summary>
    /// <param name="blobName">The name of the blob to delete.</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    Task DeleteBlob(string blobName, CancellationToken cancellationToken);

    /// <summary>Downloads the content of a blob as a byte array.</summary>
    ...
    /// <summary>Lists all blobs in the container, optionally filtered by a name prefix.</summary>
    ...
    /// <summary>Retrieves the distinct virtual directory prefixes (one level deep) within the container.</summary>
